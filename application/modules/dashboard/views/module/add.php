            ...
            <div class="panel-body">
                ...
                <div class="col-sm-12 thumbnail">
                    <?php echo form_open_multipart("dashboard/module/upload/", 'class="form-inline"') ?>
                        ...
                        <div class="form-group">
                            <input type="file" name="module" class="form-control" disabled="disabled">
                        </div> 
                        <div class="form-group">
                            <input type="checkbox" name="overwrite"  value="false" id="overwrite"> <label for="overwrite" disabled="disabled"><?php echo display("overwrite") ?></label>
                        </div> 
                        <div class="form-group">
                            <button type="submit" class="btn btn-success" disabled="disabled"><?php echo display('add_module') ?></button>
                        </div> 
                    <?php echo form_close() ?>
                </div>
