            ...
            <div class="col-sm-12">
                <div class="tools-ber">
                    <div class="row form-block">
                        <form action="<?php echo base_url('mobile/search') ?>">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-7 col-xs-12"> 
                        <?php echo form_open('mobile/search/booking/', array('class' => 'price-details', 'id'=>'bookingFrm')) ?>
...
$(document).ready(function() {
    ...
    */
    ...
    $('#myModal').on('shown.bs.modal', function (event) {
        ...
        $.ajax({
            url: '<?php echo base_url('mobile/search/findBookingInformation') ?>',
            method  : 'post',
            dataType: 'json',
            data    : {
    ...
    */
    ...
    $('body').on('click', '.ChooseSeat', function(){
        ...
        // $.ajax({
        //     url : '<?php echo base_url('mobile/search/findPriceBySeat') ?>',
        //     method: 'post',
        //     dataType: 'json',
        //     data: 
        //     {
    ...
    */ 
    $("#offerCode").on('keyup', function(){
        ...
        if ($(this).val().length > 2) {
            ...
            $.ajax({
                url : '<?php echo base_url('mobile/search/findOfferByCode') ?>',
                method: 'post',  
                dataType: 'json',          
                data: {
                    '<?php echo $this->security->get_csrf_token_name() ?>':'<?php echo $this->security->get_csrf_hash() ?>',
