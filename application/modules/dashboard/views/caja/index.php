            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="info-box bg-olive bg-success" style="padding: 10px">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="info-box bg-yellow bg-warning" style="padding: 10px">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="info-box bg-navy-blue bg-primary" style="padding: 10px">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="info-box bg-blue bg-info" style="padding: 10px">
...
<div class="modal fade" id="agregar_movimiento" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open('/dashboard/caja/guardar') ?>
...
<div class="modal fade" id="apertura_caja" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open('/dashboard/caja/apertura') ?>
          <div class="modal-body">
            <div class="form-group">
                <label for="monto">Monto</label>
