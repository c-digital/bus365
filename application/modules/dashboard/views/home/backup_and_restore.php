            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    ...
                    <?php echo form_open('dashboard/backup_restore/process', "id='brFrm'") ?>
                            ...
                            <a href="<?php echo base_url('dashboard/backup_restore/download') ?>" class="btn btn-success w-md m-b-5 btn-block" onclick="return confirm('<?php echo display("are_you_sure") ?>')"><i class="fa fa-download"></i> <?php echo display('backup_and_download') ?></a>
