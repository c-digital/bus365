            ...
            <div class="container-center">
                <div class="panel panel-bd">
                    ...
                    <div class="panel-body">
                        <?php echo form_open_multipart('mobile/auth/user_info','class="form-inner"') ?>
  ...
  <div class="modal-dialog">
        <div class="modal-content"> 
            ...
            <div class="modal-body">
                 <?php echo form_open('mobile/auth/passenger_password_recovery/', array('class' => 'row', 'id'=>'checkoutFrm')) ?>
                ...
                <div class="modal-body">
                  <div id="outputmessage" class="alert hide modal-title" role="alert" >
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                         ...
                         <?= form_open_multipart('mobile/user/registration', array("id"=>"regform")) ?>
