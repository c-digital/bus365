    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?= form_open('/dashboard/companies/update', ['enctype' => 'multipart/form-data']) ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input required name="nit" value="<?php echo $company->nit ?>" class="form-control" type="text" placeholder="<?php echo display('nit') ?>" id="nit">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input required name="name" value="<?php echo $company->name ?>" class="form-control" type="text" placeholder="<?php echo display('name') ?>" id="name">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input name="address" class="form-control" value="<?php echo $company->address ?>" type="text" placeholder="<?php echo display('address') ?>" id="address">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input name="lane" class="form-control" value="<?php echo $company->lane ?>" type="text" placeholder="<?php echo display('lane') ?>" id="lane">
                        </div>
                    </div>
