...
<span style=" float:right;">
        <ul class="nav navbar-nav">
            ...
            <li> <?php
                ...
                <a href="<?php echo base_url('website/User/upform_pasenger/').$this->session->userdata('id_no') ?>" class="btn btn-sm profile_btn" title="Edit"><?php echo display('profile') ?></a> </li>
...
<div id="add1" class="modal fade" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#c1272d; color: white">
