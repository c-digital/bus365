                ...
                <?= form_open_multipart('ticket/passenger/form') ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                <div class="col-sm-4">
                                    <input name="firstname" class="form-control" type="text" placeholder="<?php echo display('firstname') ?>" id="name" value="<?php echo $passenger->firstname ?>"  required>
                                </div>
                                <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="email" class="form-control" type="email" placeholder="<?php echo display('email') ?>" id="email" value="<?php echo $passenger->email ?>" required>
                        </div>
                    </div> 
                    ...
                    <div class="form-group row">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="nid" class="form-control" type="text" placeholder="<?php echo display('nid') ?>" id="nid" value="<?php echo $passenger->nid ?>" required>
                        </div>
                    </div> 
