    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 p-5">
                        <div class="bg-success">
                            <span class="info-box-icon"><i class="fa fa-arrow-up"></i></span>

                            <div class="info-box-content">
                              <span class="info-box-text"><?php echo display('ins') ?></span>
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="info-box bg-warning">
                            ...
                            <div class="info-box-content">
                              <span class="info-box-text"><?php echo display('outs') ?></span>
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="bg-primary info-box bg-navy-blue">
                            <span class="info-box-icon"><i class="fa fa-money"></i></span>

                            <div class="info-box-content">
                              <span class="info-box-text"><?= 'money_in_cash' ?></span>
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="info-box bg-info bg-blue">
